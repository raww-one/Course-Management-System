...
public class Bba extends JFrame implements ActionListener{
    ...
    public Bba(){
        ...
        //finance
        icon1 = new ImageIcon(getClass().getResource("/images/finance.jpg"));
        label1 = new JLabel(icon1);
        label1.setBounds(10, 30, 350, 200);
        panel.add(label1);

        label2 = new JLabel("Banking and Finance Management");
        ...
        //Travel
        icon2 = new ImageIcon(getClass().getResource("/images/travel.jpg"));
        label4 = new JLabel(icon2);
        label4.setBounds(0, 350, 350, 200);
        panel.add(label4);

        label5 = new JLabel("Travel and Tourism Management");
        label5.setFont(new Font("Arial", Font.BOLD, 15));
        label5.setBounds(60, 465, 350, 200);
        panel.add(label5);
        ...
        //human
        icon3 = new ImageIcon(getClass().getResource("/images/human.jpeg"));
        label5 = new JLabel(icon3);
        label5.setBounds(620, 30, 400, 200);
        panel.add(label5);

        label6 = new JLabel("Human Resource Management");
        label6.setFont(new Font("Arial", Font.BOLD, 15));
        label6.setBounds(700, 135, 350, 200);
        panel.add(label6);
        ...
        //International
        icon4 = new ImageIcon(getClass().getResource("/images/international.jpeg"));
        label6 = new JLabel(icon4);
        label6.setBounds(620, 340, 400, 200);
        panel.add(label6);

        label7 = new JLabel("International Business");
        label7.setFont(new Font("Arial", Font.BOLD, 15));
        label7.setBounds(735, 445, 350, 200);
        panel.add(label7);
