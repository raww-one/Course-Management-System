...
public class Cse extends JFrame implements ActionListener{
    ...
    public Cse(){
        ...
        //OOP
        icon1 = new ImageIcon(getClass().getResource("/images/Javaimage.png"));
        label1 = new JLabel(icon1);
        label1.setBounds(0, 30, 350, 200);
        panel.add(label1);

        label2 = new JLabel("Object Oriented Programming 1");
        ...
        //CPP
        icon2 = new ImageIcon(getClass().getResource("/images/Cppimage.png"));
        label4 = new JLabel(icon2);
        label4.setBounds(0, 340, 350, 200);
        panel.add(label4);

        label5 = new JLabel("Introduction to Programming");
        ...
        //DM
        icon3 = new ImageIcon(getClass().getResource("/images/DMimage.jpg"));
        label5 = new JLabel(icon3);
        label5.setBounds(620, 30, 400, 200);
        panel.add(label5);

        label6 = new JLabel("Discrete Mathematics");
        label6.setFont(new Font("Arial", Font.BOLD, 15));
        label6.setBounds(760, 130, 350, 200);
        panel.add(label6);
        ...
        //DS
        icon4 = new ImageIcon(getClass().getResource("/images/DSimage.png"));
        label6 = new JLabel(icon4);
        label6.setBounds(620, 340, 400, 200);
        panel.add(label6);

        label7 = new JLabel("Data Structure");
        label7.setFont(new Font("Arial", Font.BOLD, 15));
        label7.setBounds(770, 440, 350, 200);
        panel.add(label7);
